...
* I tested the phrase converter function to loop on a set of documents for a single phrase (inshaaAllah) and it works! See Codebook function "convert phrases in multiple files". 
