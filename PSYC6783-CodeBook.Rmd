...
dashedFiles <- paste("isadash.",fileNames, sep="")
...
for(i in 1:length(fileNames))
{
  ...
  tempdata.isadash <- str_replace_all(tempdata,isa,isa_dash) 

  write.table(tempdata.isadash, file=dashedFiles[i], row.names = FALSE, col.names=FALSE, fileEncoding = "UTF-8", quote=FALSE) 
}
