...
str_replace_all(doctext2,isa,isa_dash) #doesn't seem to work
str_detect(docflat,isa_dash)
str_detect(docflat,isa)
str_replace_all(docflat,isa,isa_dash)
write.table(doctext2, file="UB07_isaPhrased.txt", row.names = FALSE, col.names=FALSE, fileEncoding = "UTF-8", quote=FALSE)
#success!
```
